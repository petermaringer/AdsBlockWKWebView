...
enum X509Error: Error {
    ...
    //let pemCer = ""
    let pemCer = try! String(data: Data(contentsOf: FileManager.default.url(for: .documentDirectory, in: .userDomainMask, appropriateFor: nil, create: false).appendingPathComponent("ssl.pem").path), encoding: .utf8)
    /*
    do {
